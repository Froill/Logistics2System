<div class="bg-[#001f54] pt-5 pb-4 flex flex-col fixed md:relative h-vh transition-all duration-300 ease-in-out shadow-xl transform -translate-x-full md:transform-none md:translate-x-0" id="sidebar">
  <!-- Sidebar Header -->
